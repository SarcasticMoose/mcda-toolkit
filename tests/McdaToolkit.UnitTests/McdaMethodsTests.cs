...
public class McdaMethodsTests
{
    ...
    public void Calculate_VikorMethod_ShouldBeEqualToExpected()
    {
        ...
        var expectedVikorScore = new Ranking<VikorScore>(new List<RankingRow<VikorScore>>
        {
            new(1, 7, new VikorScore { Q = 0.297, R = 0.15, S = 0.473 }),
            new(2, 2, new VikorScore { Q = 0.661, R = 0.25, S = 0.563 }),
            new(3, 3, new VikorScore { Q = 0.63, R = 0.255, S = 0.529 }),
            new(4, 9, new VikorScore { Q = 0.123, R = 0.1, S = 0.434 }),
            new(5, 10, new VikorScore { Q = 0.05, R = 0.12, S = 0.337 }),
            new(6, 8, new VikorScore { Q = 0.272, R = 0.167, S = 0.42 }),
            new(7, 4, new VikorScore { Q = 0.497, R = 0.2, S = 0.532 }),
            new(8, 5, new VikorScore { Q = 0.436, R = 0.175, S = 0.534 }),
            new(9, 1, new VikorScore { Q = 1.0, R = 0.3, S = 0.733 }),
    ...
    public void Calculate_Promethee2Method_ShouldBeEqualToExpected()
    {
        ...
        double[] weights =
        {
            0.2122, 0.1678, 0.0633, 0.0345, 0.1123,
            0.0798, 0.0112, 0.0860, 0.1584, 0.0745
        };
