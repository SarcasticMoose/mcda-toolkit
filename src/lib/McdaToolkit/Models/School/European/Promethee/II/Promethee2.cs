...
public class Promethee2 : McdaMethod<double>
{
    ...
    private Matrix<double> AggregatePreferenceFlows(
        Matrix<double> weightedMatrix,
    ...
    protected override IEnumerable<double> Execute(McdaInputData data)
    {
        ...
        var flowMatrix = AggregatePreferenceFlows(
            weightedPreferenceMatrix,
            normalizedMatrix.RowCount
        );
