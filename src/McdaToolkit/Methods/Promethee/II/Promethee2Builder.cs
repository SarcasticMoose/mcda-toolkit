...
internal sealed class Promethee2WithGaiaBuilder
{
    private NormalizationMethod _normalizationMethod;

    private PreferenceFunction _preferenceFunction;

    public Promethee2WithGaiaBuilder WithNormalizationMethod(NormalizationMethod normalizationMethod)
    {
        _normalizationMethod = normalizationMethod;
        return this;
    }

    public Promethee2WithGaiaBuilder WithPreferenceFunction(PreferenceFunction preferenceFunction)
    {
